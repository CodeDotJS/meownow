...
| 10 | Playground: `/play`, five local notes, no Neon | A guest can write 5 notes on `/play`; Forget frees a slot; a guest POST is still denied; join discards the playground store |
